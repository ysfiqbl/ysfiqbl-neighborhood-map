$(document).ready(function() {
    ...
    var ViewModel = function() {
        ...
        self.showLocation = function(loc) {
            ...
            if (self.infowindow === undefined || self.infowindow.marker !== loc.marker) {
                ...
                self.infowindow =  new google.maps.InfoWindow({
                    content: getInfoWindowContent(loc)
                })
        ...
        /**
         * Create the nodes and attach even listeners to the infowindow.
         * @return HTMLElement div that represents the infowindow content
         */
        function getInfoWindowContent(loc) {
            ...
            saveIcon.classList.add('glyphicon');
            saveIcon.classList.add('glyphicon-save');
