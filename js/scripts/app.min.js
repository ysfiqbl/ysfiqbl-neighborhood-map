$(document).ready(function() {
	...
	function FoursquareRequest() {
		...
		this.data = {
			'client_id': 'ERHT3FHFXMWICB0G4LBHE1GU51LFYBYP3JS0DJU2LPAZAXDR',
			'client_secret': '1HPXTVYASF2DDEHPPN14XHEQW0B2R1WI4GDY1MVMTYZN3XGK',
			'v': '20130815',
			'radius': 50,
			'intent': 'browse'
		};
	...
	(function() {
		this.search = function(data, callback) {
			...
			this.data['ll'] = data.ll;
			this.data['query'] = data.query;
			if (this.xhr && this.xhr.readyState != 4) {
				this.xhr.abort();
				console.log('Aborted previous request');
			}
			$.get(url, this.data, callback, 'json');
		};
	}).call(FoursquareRequest.prototype);


	function InstagramRequest() {
		this.index = 'https://api.instagram.com/oauth/authorize/';
		this.client_id = '06765125f7c34de98731185588aa6036';
		this.client_secret = '02d9fde131ca4900b353be3348c5a95e';
		this.access_token = '2033671651.0676512.e153a0cb659c47d8ae40883f871eb5ad';
	}
	(function() {
	...
	}).call(InstagramRequest.prototype);
	...
	var ViewModel = function() {
		...
		self.instagramRequest = undefined;
		 ...
		 */
		self.foursquareResponseHandler = function(obj) {
