    ...
    var ViewModel = function() {
        ...
        self.locationSearchSuggestions = ko.computed(function() {
            ...
            if (query == '' && self.showListView() == true) {
                return ko.utils.arrayFilter(self.localStoreLocations, function(loc, index) {
                    self.allLocations()[index].marker.setVisible(true);
                    return true;
                });
            } else {
                return ko.utils.arrayFilter(self.localStoreLocations, function(loc, index) {
                    var result = loc.title.toLowerCase().indexOf(query) > -1;
                    m = self.allLocations()[index].marker;
                    m.setVisible(result);
        ...
        self.showLocation = function(loc) {
            if (!(loc instanceof Location)) {
                ...
                if (index > -1) {
                    self.currentLocation(self.allLocations()[index]);
                } else {
